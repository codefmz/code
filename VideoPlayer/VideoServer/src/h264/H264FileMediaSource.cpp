...
H264FileMediaSource* H264FileMediaSource::createNew(ThreadPool* pool, std::string file)
{
    return new H264FileMediaSource(pool, file);
}

H264FileMediaSource::H264FileMediaSource(ThreadPool* pool, const std::string& file) : MediaSource(pool), mFile(file)
{
