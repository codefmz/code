...
H264RtpSink* H264RtpSink::createNew(EventScheduler* scheduler, MediaSource* mediaSource)
{
    if(!mediaSource) {
        return NULL;
    }

    return new H264RtpSink(scheduler, mediaSource);
}

H264RtpSink::H264RtpSink(EventScheduler* scheduler, MediaSource* mediaSource) :
