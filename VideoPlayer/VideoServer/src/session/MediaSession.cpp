...
MediaSession::MediaSession(const std::string& sessionName) : mSessionName(sessionName), mIsStartMulticast(false)
{
...
bool MediaSession::addRtpSink(TrackId trackId, RtpSink* rtpSink)
{
    Track* track;
