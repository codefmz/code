...
TiledListView::TiledListView(QWidget *parent) : QAbstractItemView(parent), idealWidth(0), idealHeight(0), hashIsDirty(false)
{
...
void TiledListView::scrollTo(const QModelIndex &index, QAbstractItemView::ScrollHint)
{
    ...
    if (itemRect.left() < viewRect.left()) {
        ...
        horizontalScrollBar()->setValue(horizontalScrollBar()->value() + qMin(itemRect.right() - viewRect.right(),
    ...
    if (itemRect.top() < viewRect.top()) {
        ...
        verticalScrollBar()->setValue(verticalScrollBar()->value() + qMin(itemRect.bottom() - viewRect.bottom(),
...
void TiledListView::setSelection(const QRect &rect, QFlags<QItemSelectionModel::SelectionFlag> flags)
{
